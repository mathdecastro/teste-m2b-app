...
def criar_dataframe_ofertas(dataframe_ofertas):
    """
    CRIA O DATAFRAME DE OFERTAS, TRATANDO TELEFONES INVÁLIDOS.
...
def criar_dataframe_tratativas(dataframe_tratativas):
    """
    CRIA O DATAFRAME DE TRATATIVAS, TRATANDO TELEFONES INVÁLIDOS.
    
    PARÂMETROS:
    - dataframe_tratativas: DATAFRAME DE TRATATIVAS (EX: tratativas_teste.csv)
    """
